...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (csv-mode ivy-rich evil-org ag multi-term evil-matchit ruby-electric company-robe exec-path-from-shell hydra xref-js2 js2-refactor js2-mode json-mode web-mode markdown-mode counsel-projectile projectile evil-leader evil-magit magit ivy doom-themes doom-modeline use-package evil))))
(custom-set-faces

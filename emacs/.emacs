...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (powerline key-chord git-ps1-mode web yaml-mode powerline-evil company yasnippet-classic-snippets dizzee osx-clipboard origami prettier-js json-mode prodigy ivy tide php-mode sauron web-mode handlebars-mode all-the-icons-dired doom-themes all-the-icons neotree visual-fill-column evil-magit editorconfig yasnippet which-key vimish-fold use-package reveal-in-osx-finder relative-line-numbers osx-trash multi-term markdown-mode magit js2-mode helm-projectile helm-flyspell helm-ag flycheck fill-column-indicator exec-path-from-shell evil-matchit evil-leader emmet-mode dired-subtree dired-narrow diff-hl deft base16-theme avy auto-complete alert))))
